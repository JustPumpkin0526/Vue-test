    ...
    <div class="flex p-4 space-x-4">
        ...
        <div class="w-full h-24 bg-white border border-gray-300 rounded p-2 flex flex-col justify-start relative">
          ...
          <div class="relative w-full" ref="dropdownRef">
            ...
            <transition
              ...
              enter-from-class="opacity-0 transform scale-y-75"
      ...
      <div class="w-2/3 flex flex-col space-y-4">
        ...
        <div class="flex space-x-2">
          <textarea class="w-full border border-gray-300 rounded p-2 h-24" placeholder="Ask a question" v-model="question"></textarea>
